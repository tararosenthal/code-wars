...
class JustifyStringTests {
    @Test
    void sampleTests() {
        assertEquals("123  45\n6", JustifyString.justify("123 45 6", 7));
        assertEquals("123", JustifyString.justify("123", 7));
        assertEquals("", JustifyString.justify("", 10));
    }
    ...
    void descriptionExample() {
        ...
        assertEquals(expected, JustifyString.justify(LIPSUM, 30));
    }
}
